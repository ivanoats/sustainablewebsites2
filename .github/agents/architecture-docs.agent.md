...
description: This agent creates files in a docs/ directory that describe the repository's architecture and data flows using prose and diagrams
---

# Architecture and Documentation Agent
